...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-123897365-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-123897365-1');
</script>
    <meta charset="utf-8">
    ...
    <link rel="icon" type="image/x-icon" href="<?= asset_url('assets/img/LOGO.jpg') ?>">
    <link rel="icon" sizes="192x192" href="<?= asset_url('assets/img/LOGO.jpg') ?>">
</head>
<body>
            ...
            <div id="success-frame" class="frame-container
                ...
                <div class="col-xs-12 col-sm-10">
                    <?php
                        ...
                        //display cancel appointment button
                       echo ' 
                       <a href="' . site_url('appointments/cancel/' . $appointment_data['hash']) . '" class="btn btn-primary btn-large">
                       <span class="glyphicon glyphicon-trash"></span> ' .
                       lang('cancel_appointment_title') .'
                   </a> ';
                            //display google calender button
