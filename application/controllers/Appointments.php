    ...
    public function pay(){
       ...
       // Lipa na M-Pesa Online Payment API is used to initiate a M-Pesa transaction on behalf of a customer using STK Push. This is the same technique mySafaricom App uses whenever the app is used to make payments.
        ...
        // echo $postData;  
            ...
            // $CallBackURL = $jdata["CallBackURL"];
            // $AccountReference = $jdata ["AccountReference"];
            // $TransactionDesc = $jdata["TransactionDesc"];
            ...
            // $PhoneNumber = $jdata["PhoneNumber"];
            // mysql_query( "INSERT INTO mpesa_api(BusinessShortCode, Password, Timestamp, TransactionType, Amount,PartyA,PartyB,PhoneNumber, CallBackURL,AccountReference,TransactionDesc,status,statussms) VALUES ('$TransactionType',
        ...
        //    / var_dump($TransactionType);
            ...
            $mysql_query =  "INSERT INTO mpesa_api(TransactionType, TransID, TransTime, TransAmount, BusinessShortCode,BillRefNumber,InvoiceNumber,MSISDN,FirstName,MiddleName,LastName,OrgAccountBalance,status,statussms) VALUES ('$TransactionType',
            '$TransID', '$TransTime','$TransAmount','$BusinessShortCode','$BillRefNumber','$InvoiceNumber','$MSISDN','$FirstName','$MiddleName','$LastName','$OrgAccountBalance','0','0')";
